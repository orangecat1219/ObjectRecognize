...
# 网格搜索主逻辑
def run_grid_search(train_path, test_path, k_list, kernels, C_list, selected_classes=7, save_dir="SIFT_iCubWorld_results"):
    ...
    for k, kernel, C in product(k_list, kernels, C_list):
    ...
    # 保存最佳模型
    best_folder = f"best_SIFT_iCubWorld_k-{best_model_data['k']}_kernel-{best_model_data['kernel']}_C-{best_model_data['C']}"
